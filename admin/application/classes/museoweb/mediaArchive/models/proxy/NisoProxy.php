...
class museoweb_mediaArchive_models_proxy_NisoProxy extends PinaxObject
{
    public function save($data, $mode = 'edit')
    {
        $niso = pinax_ObjectFactory::createModel('museoweb.mediaArchive.models.Niso');
        if ($mode === 'add') {
    ...
    public function get($imageId)
    {
        if($imageId)
        {
          $ar = pinax_ObjectFactory::createModel('museoweb.mediaArchive.models.Niso');
