<?php
class metafad_archive_views_components_Tree  extends pinax_components_Component
{
    /**
     * Init
     *
    ...
    public function render($outputMode=NULL, $skipChilds=false) {
        ...
        if (!pinax_ObjectValues::get('pinaxcms.js', 'jsTree', false))
        {
            ...
            /*$this->addOutputCode( pinax_helpers_JS::linkStaticJSfile( 'jquery/jquery-jstree/jquery.cookie.js' ) );
            $this->addOutputCode( pinax_helpers_JS::linkStaticJSfile( 'jquery/jquery-jstree/jquery.jstree.js' ) );*/
            $this->addOutputCode( pinax_helpers_JS::linkStaticJSfile( 'jquery/jquery-ui/jquery-ui-1.10.0.custom.min.js' ) );
...
class metafad_archive_views_components_Tree_render extends pinax_components_render_Render
{
