<?php
class museoweb_modules_ecommerce_views_components_admin_OrderDetail extends pinax_components_Component
{
    function render($outputMode=NULL, $skipChilds=false)
    {
        $recordId = __Request::get('id');
        $itOrder = pinax_ObjectFactory::createModelIterator( 'museoweb.modules.ecommerce.models.OrderItem',
                                                                    'orderDetailForAdmin',
                                                                    array(
