<?php
class museoweb_modules_ecommerce_views_components_Cart extends pinax_components_Component
{
    function init()
    {
    ...
    function process()
    {
        ...
        pinax_helpers_Array::arrayMultisortByLabel( $this->_content[ 'records' ], 'title' );
    }
}
