# metaFAD Portale
Portale di consultazione, parte del progetto metaFAD.
...
## Accesso
L'indirizzo da digitare nel browser per raggiungere il progetto è:

- http://metafad-portale.localhost
- http://metafad-portale.localhost/admin
...
# Licenza
"metaFAD portale" è rilasciato con licenza [GNU AFFERO GENERAL PUBLIC LICENSE v3](LICENSE)
